...
def sisa_BPRMF_unlearning_eva(shard_models, shards, retain_data, forget_data, config, device='cpu'):
    num_users = config['num_users']
    num_books = config['num_books']
    k = config['k']
    epochs = config['epochs']
...
def sisa_BPRMF_forget_data_eva(shard_models, forget_data, config, device='cpu'):
    num_users = config['num_users']
    num_books = config['num_books']
    num_shards = config['num_shards']
    embedding_dim = config['embedding_dim']
